...
class MyCupertinoActivityIndicator extends StatefulWidget {
  ...
  @override
  _MyCupertinoActivityIndicatorState createState() => _MyCupertinoActivityIndicatorState();
}


class _MyCupertinoActivityIndicatorState extends State<MyCupertinoActivityIndicator> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: CustomPaint(
        painter: _MyCupertinoActivityIndicatorPainter(
          position: _controller!,
          activeColor: Color(0xFFEBEBF5),
...
class _MyCupertinoActivityIndicatorPainter extends CustomPainter {
  _MyCupertinoActivityIndicatorPainter({
  ...
  @override
  bool shouldRepaint(_MyCupertinoActivityIndicatorPainter oldPainter) {
